...
public class QrCodeRecenter : MonoBehaviour
{
    ...
    private void SetQrCodeRecenterTarget(string targetText)
    {
        ...
        if (currentTarget != null)
        {
            ...
            // Apply the new position and rotation to the ARSessionOrigin's camera
            sessionOrigin.transform.localPosition = currentTarget.PositionObject.transform.position;
            sessionOrigin.transform.localRotation = currentTarget.PositionObject.transform.rotation;
        }
    }
